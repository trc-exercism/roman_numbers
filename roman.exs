defmodule Roman do
  ...
  def get_thousands(thousands) do 
  ...
  def check_repetitions([] , _, _, _, _, list), do: list
  def check_repetitions([h|t] , repetitions, repetitions, _, substitute_by, _), do: substitute_by ++ ([h] ++ t)
  #
